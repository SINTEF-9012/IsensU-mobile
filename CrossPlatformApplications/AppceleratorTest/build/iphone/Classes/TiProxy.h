...
//Rare exceptions to indicate a bug in the _appceleratortest1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for AppceleratorTest1 proxies.
 */
