...
@interface AppceleratorTest1Object : KrollCoverageObject {
#else
@interface AppceleratorTest1Object : KrollObject {
#endif
@private
...
extern NSString * AppceleratorTest1Test1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AppceleratorTest1Object *_appceleratortest1;
    KrollObject* console;
	BOOL shutdown;
