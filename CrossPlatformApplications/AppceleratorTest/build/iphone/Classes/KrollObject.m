...
//@interface AppceleratorTest1Object : NSObject
//@end

@interface AppceleratorTest1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AppceleratorTest1Object class]])
		{
			for (NSString *key in [[(AppceleratorTest1Object*)o modules] allKeys])
			{
