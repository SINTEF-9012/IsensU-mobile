...
// in simulator we redefine to format for AppceleratorTest1 Developer console
...
{\
	NSString * exceptionName = [@"org.appceleratortest1." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.appceleratortest1";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIAppceleratorTest1NativeItemNone = -1, 
	UIAppceleratorTest1NativeItemSpinner = -2,
	UIAppceleratorTest1NativeItemProgressBar = -3,
	
	UIAppceleratorTest1NativeItemSlider = -4,
	UIAppceleratorTest1NativeItemSwitch = -5,
	UIAppceleratorTest1NativeItemMultiButton = -6,
	UIAppceleratorTest1NativeItemSegmented = -7,
	
	UIAppceleratorTest1NativeItemTextView = -8,
	UIAppceleratorTest1NativeItemTextField = -9,
	UIAppceleratorTest1NativeItemSearchBar = -10,
	
	UIAppceleratorTest1NativeItemPicker = -11,
	UIAppceleratorTest1NativeItemDatePicker = -12,
	
	UIAppceleratorTest1NativeItemInfoLight = -13,
	UIAppceleratorTest1NativeItemInfoDark = -14,
	
	UIAppceleratorTest1NativeItemDisclosure = -15,
	
	UIAppceleratorTest1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AppceleratorTest1 instances of
