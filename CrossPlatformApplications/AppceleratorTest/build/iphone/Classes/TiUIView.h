...
/**
 Base class for all AppceleratorTest1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AppceleratorTest1 view hierarchy (such as wrapped iOS UIViews) was touched.
