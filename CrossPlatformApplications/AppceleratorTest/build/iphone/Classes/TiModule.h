...
/**
 The base class for all AppceleratorTest1 modules
 */
...
/**
 AppceleratorTest1 Platform calls this method on startup.
 */
-(void)startup;

/**
 AppceleratorTest1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AppceleratorTest1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AppceleratorTest1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AppceleratorTest1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
