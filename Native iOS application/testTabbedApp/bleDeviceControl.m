...
@synthesize peripheralBatteryLevels;
@synthesize peripheralTemperatures;
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error {
    ...
    peripheralTemperatures = [[NSMutableDictionary alloc] init];
    peripheralBatteryLevels = [[NSMutableDictionary alloc] init];
    ...
    if (!error) {
        ...
        // checks characteristics for service

        // [peripheral discoverCharacteristics:[NSArray arrayWithObject: [CBUUID UUIDWithString:@"2a1c"]] forService:[NSArray arrayWithObject: [CBUUID UUIDWithString:@"1809"]]];
...
-(void) convertTemperature:(NSString *)nsdataobject
{
    ...
    //test: (result should be 26.05 degrees)
    //NSString *a = @"<002d0a00 fe3d04>";
...
-(void)readCharacteristic:(CBPeripheral *)peripheral sUUID:(NSString *)sUUID cUUID:(NSString *)cUUID {
    ...
    //[peripheral readValueForCharacteristic:[NSArray arrayWithObject: [CBUUID UUIDWithString:@"1809"]]];
